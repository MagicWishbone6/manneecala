	...
	return (
		<Container fluid>
			...
			<Row>
				...
				<Col>
					<Side playerNum={1} onClickCupButton={handleClickCupButton} cupValues={cupAndBankValues}/>
					<br />
					<Side playerNum={2} onClickCupButton={handleClickCupButton} cupValues={cupAndBankValues}/>
				</Col>
				<Col xl="2">
